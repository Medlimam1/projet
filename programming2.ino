...
const char *ssid = "justdoelectronics";  //ENTER YOUR WIFI SETTINGS
const char *password = "pratik123";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http:// 192.168.43.239/biometricattendance/getdata.php"; //computer IP or the server domain
